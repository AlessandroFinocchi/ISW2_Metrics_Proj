...
public class TrainingTestSetsProcessor {
    ...
    public int processWalkForward(GitScraper gitScraper, List<Release> releaseList, List<Ticket> ticketList,
        ...
        return trainingsetReleaseList.size();
    }
    ...
    private void processTrainingSet(GitScraper gitScraper, List<Release> currentReleaseList, List<Ticket> currentTicketList,
        ...
        DatasetsProcessor.writeDataset(projName, currentReleaseList, currentClassList, currentRelease.getNumericID(),
    ...
    private void processTestingSet(GitScraper gitScraper, List<Release> releaseList, List<Ticket> currentTicketList,
        ...
        loggerString = projName + " Testing set build on release " + (predictingRelease.getNumericID() - 1) + "\n";
        logger.info(loggerString);
    }
}
